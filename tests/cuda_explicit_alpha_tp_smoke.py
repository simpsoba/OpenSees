"""Smoke test for CudaExplicitAlpha_TP + CuDSS SOE on a 2-DOF truss-like model."""
...
ops.integrator("CudaExplicitAlpha_TP", 0.5, 0.5, 0.5, 0.25)
...
print("CudaExplicitAlpha_TP smoke test passed.")
