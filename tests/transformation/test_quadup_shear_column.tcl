...
#
# Exercises TransformationFE T^T K T with rectangular mixed-ndf blocks. With
# the Matrix::addMatrixTripleProduct rectangular-bound bug the tangent is
# malformed and this analysis diverges outright on the very first step.
#
