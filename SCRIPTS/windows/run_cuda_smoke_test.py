"""Run cuda_explicit_alpha_smoke.py after setvars; cuDSS/CUDA on PATH + add_dll_directory for Python."""
import os
import runpy
import sys
...
runpy.run_path(os.path.join(root, "tests", "cuda_explicit_alpha_smoke.py"), run_name="__main__")
